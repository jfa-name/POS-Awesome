...
if (frappe.boot.lang == "pt") {
	$.extend(
		...
		"Return Delivery Note Total Not Correct": "Total da Devolução da Factura não está Correcto",
		"Return Delivery Note Total should not be higher than {0}": "Total da Devolução da Factura não deve maior que {0}",
		"The item {0} cannot be returned because it is not in the Delivery Note {1}": "O item {0} não pode ser devolvido porque não está na factura {1}",
		...
		"Select Hold Delivery Note": "Selecionar Factura em Pausa",
		...
		"Select Return Delivery Note": "Selecione a Factura para Devolução",
